...
cmd_parser.add_argument('--make_bullet', type=int, default=make_bullet)
cmd_args = cmd_parser.parse_args()

noise_strength = cmd_args.noise_strength
dataset_type = cmd_args.dataset_type
make_bullet = cmd_args.make_bullet
...
if __name__ == "__main__":
    ...
    if is_uneven:
        train_data, val_data, test_data, shapes_probs, colors_probs = get_datasets_smart(train_size, val_size, test_size, f_generate_dataset, is_uneven, folder_name)
    else:
        train_data, val_data, test_data = get_datasets_smart(train_size, val_size, test_size, f_generate_dataset, is_uneven, folder_name)
